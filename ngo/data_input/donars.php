  ...
  <div class="card mt-5">
    ...
    <?php
          ...
          error_reporting(E_ALL);
                      require_once('../Models/donalmodel.php');
                    if(isset($_POST['submit'])){
                      $insert_data = new donalmodel_model();
                      echo $insert_data->send_donar($_POST['name'],$_POST['phone'],$_POST['email'],$_POST['address'],$_POST['url']);
                    }
                  ?>
      <form method="POST">
        <div class="form-group">
          <label for="name">donar Name</label>
          <input type="text" name="name" id="name" class="form-control"placeholder="Enter donar name" required>
        </div>
        <div class="form-group">
		...
		<div class="form-group">
          <input type="hidden" name="ngo_id" id="ngo_id" value="2">
        </div>
         <div class="form-group">
