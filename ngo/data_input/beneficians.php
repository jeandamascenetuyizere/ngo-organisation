    ...
    <?php
          ...
          error_reporting(E_ALL);
                    ...
                    if(isset($_POST['submit'])){
                      $insert_data = new beneficiary_model();
                      echo $insert_data->send_beneficiary($_POST['names'],$_POST['phone'],$_POST['email'],$_POST['dob']);
                    }
                  ?>
      <form method="POST">
        <div class="form-group">
          <label for="name">benefician Name</label>
          <input type="text" name="names" id="name" class="form-control"placeholder="Enter benefician name" required>
        </div>
        <div class="form-group">
		...
		<div class="form-group">
          <input type="hidden" name="ngo_id" id="ngo_id" value="1">
        </div>
         <div class="form-group">
          ...
          <div class="col-sm-8">
            <h1>Reports of all beneficians</h1>
          <?php 
          require('report_beneficians.php') 
          ?>
          </div>
        </div>
      </div>
