    ...
    <?php
          ...
          error_reporting(E_ALL);
                    ...
                    if(isset($_POST['submit'])){
                      $insert_data = new rolemodel_model();
                      echo $insert_data->send_role($_POST['role_of_emp'],$_POST['created_at']);
                    }
                  ?>
      <form method="POST">
        <div class="form-group">
          <label for="name">Role Name</label>
          <input type="text" name="role_of_emp" id="name" class="form-control"placeholder="Enter role name" required>
        </div>
        <div class="form-group">
          <label for="created">date role created</label>
          <input type="date" name="created_at" id="created" class="form-control" required>
        </div>
         ...
         <div class="form-group">
          ...
          <div class="col-sm-8">
            <h1>Reports of all roles</h1>
          <?php
            require('report_roles.php') 
          ?>
          </div>
        </div>
      </div>
